...
st.markdown("""
    <div class="hero-banner">
        ...
        <p class="main-title">Movie IQ <span class="accent">Analytics</span></p>
        <p class="sub-title">Interactive financial modeling, ROI simulation, and box office analytics for producers</p>
    </div>
""", unsafe_allow_html=True)
